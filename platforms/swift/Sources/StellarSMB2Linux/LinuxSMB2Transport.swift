...
/// Linux transport backed by the project-private, statically linked libsmb2 build.
public struct LinuxSMB2Transport: SMB2Transport {
...
private actor LinuxSMB2Session: SMB2Session {
  nonisolated let connectionInfo: SMB2ConnectionInfo

  private let state: LinuxSMB2SessionState
  private let executor: SMB2BlockingExecutor
  private let runtime: SDKRuntimeDependencies
  private var disconnected = false

  init(
    state: LinuxSMB2SessionState,
